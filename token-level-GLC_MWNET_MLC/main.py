...
parser.add_argument('--dataset', type=str, choices=['cifar10', 'cifar100', 'cifarmix', 'clothing1m', 'imdb', 'mnist', 'scr', 'sst', 'twitter', 'ag', 'amazon2', 'amazon5', 'dbpedia', 'yelp2', 'yelp5', 'sogou', 'yahoo', 'imdb2', 'spouse', 'CoNLL', 'wikigold', 'NCBI', 'LaptopReview'], default='spouse')
...
token_level_datasets = ['CoNLL', 'wikigold', 'NCBI', 'LaptopReview']
